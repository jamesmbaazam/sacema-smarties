---
title: "Investigation of alerts data: Biakato"
...
This report cleans and analyses the alert data of Biakato. Input comes from an
...
## load the data
current_biakato
x_raw <- custom_import(current_biakato)
glimpse(x_raw)

## extract database date from the file name
file_name <- gsub("^[^.]+/", "", current_biakato)
...
## zone de sante
x <- mutate(x, zone_de_sante = as.character(zs)) 
...
## origin / source_notif
x <- mutate(x, origin = source_notif)
table(x$origin, useNA = "ifany")

# create variable for alert validation
x <- x %>% mutate(
  status = ifelse(conc_final %in% c("inconnu", "en_cours"),
                  "statut_inconnu", conc_final)) %>%
...
legitimate Aire de Santes belonging to Biakato present in the database). Note - All 
...
biakato_ha_pop <- pop_data$population
index <- which(is.na(biakato_ha_pop))
...
ggplot(x, aes(x = date, fill = status)) +
  ...
  labs(x = "",
       ...
       title = paste0("Nombre d'alertes par statut de validation - Biakato")) +
  large_txt +
  rotate_x_text(45) + 
  scale_months +
...
ggplot(x_prop, aes(x = epiweek_report_label, col = "#D56F3E")) +
  ...
  labs(x = "",
       ...
       title = paste0("Proportion d'alertes validées par semaine - Biakato")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") +
  scale_months
...
ggplot(x_validations, aes(x = aire_de_sante, y = n, fill = status)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par statut de validation et aire de santé - Biakato",
...
ggplot(x_validations, aes(x = aire_de_sante, y = n, fill = status)) +
  ...
  labs(x = "",
       ...
       title = paste("Nombre d'alertes par statut de validation et aire de santé",
                     "\n(avec plus de 20 alertes) - Biakato"),
        subtitle = "Données des trois dernières semaines") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(x_validations, aes(x = aire_de_sante, y = n, fill = status)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = paste("Nombre d'alertes par statut de validation et aire de santé",
                     "\n(avec moins de 20 alertes) - Biakato"),
        subtitle = "Données des trois dernières semaines") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(x, aes(x = epiweek_report_label, fill = origin)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes par semaine",
       title = "Nombre d'alertes par origine - Biakato") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45) +
  scale_months
...
ggplot(x_recent, aes(x = date, fill = origin)) +
  ...
  labs(title = "Nombre d'alertes par origine - Biakato",
        subtitle = "Données des trois dernières semaines",
       x = "",
       y = "Nombre d'alertes par jour") +
  scale_weeks
...
ggplot(x, aes(x = top_zones, fill = origin)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par origine et zone de santé - Biakato") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(x_recent, aes(x = top_zones, fill = origin)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = paste("Nombre d'alertes par origine et zone de santé - Biakato"),
        subtitle = "Données des trois dernières semaines") +
  theme(legend.position = "bottom") +
  large_txt 
...
ggplot(x_origins, aes(x = aire_de_sante, y = n, fill = origin)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par origine et aire de santé - Biakato",
       subtitle = "avec plus de 100 alertes") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(outcomes, aes(x = epiweek_report_label, fill = decision_comparison)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par décision de validation - Biakato") +
  theme(legend.position = "bottom") +
  guides(fill=guide_legend(ncol=2)) +
  large_txt +
  scale_decisions +
...
ggplot(outcomes_recent, aes(x = date, fill = decision_comparison)) +
  ...
  theme(legend.position = "bottom") +
    guides(fill=guide_legend(ncol=2)) +
  labs(title = paste("Nombre d'alertes par décision de validation - Biakato"),
       x = "",
       y = "Nombre d'alertes par jour") +
  scale_weeks
...
ggplot(outcomes, aes(x = top_zones, fill = decision_comparison)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par décision et zone de santé - Biakato") +
  theme(legend.position = "bottom") +
    guides(fill=guide_legend(ncol=2)) +
    large_txt +
  rotate_x_text(45)
...
ggplot(outcomes_recent, aes(x = top_zones, fill = decision_comparison)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = paste("Nombre d'alertes par décision et zone de santé - Biakato"),
       subtitle = "Données des trois dernières semaines") +
  theme(legend.position = "bottom") +
    guides(fill=guide_legend(ncol=2)) +
  large_txt
...
ggplot(x_decisions, 
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par décision de validation et aire de santé - Biakato",
       subtitle = "avec plus de 100 alertes") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(x_decisions, 
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = paste("Nombre d'alertes par décision de validation et aire de santé","(avec plus de 20 alertes) - Biakato"),
       subtitle = "Données des trois dernières semaines") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(x_decisions_recent, aes(x = date, fill = decision_comparison)) +
  ...
  labs(x = "",
       ...
       title = paste0("Nombre d'alertes par décision de validation",
                      " et aire de santé - Biakato"),
       subtitle = "avec moins de 20 alertes") + 
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") +
  scale_x_date(date_breaks = "1 week", date_labels =  "%d %b") 
...
ggplot(data = x_alert_rate_sous_co, 
  ...
  labs(x = "",
       ...
       title = "Nombre d'alertes par 10000 personnes - Biakato") +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") +
  scale_months
...
ggplot(data = x_alert_rate_sous_co, aes(x = date, 
  ...
  labs(x = "",
       y = "Nombre d'alertes par jour \net par 10,000 personnes",
       title = paste0("Nombre d'alertes par 10000 personnes - Biakato"),
       subtitle = "Données des trois dernières semaines") +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") +
...
ggplot(data = x_alert_rate_zone_sante, aes(x = zone_de_sante, 
  ...
  labs(x = "",
       ...
       title = paste0("Nombre d'alertes par 10000 personnes par statut\n", 
                      "de validation et zone de santé - Biakato")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom")
...
ggplot(data = x_alert_rate_zone_sante, aes(x = aire_de_sante, 
  ...
  labs(x = "",
       y = "Nombre d'alertes par semaine \net par 10,000 personnes",
       title = paste0("Nombre d'alertes par 10000 personnes par statut ", 
                      "de validation et aire de santé - Biakato")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") 
...
*NOTE*: As of the latest database from Biakato on Dec, 12th 2019, the **final outcome of the alerts**, in the variable `class_final` was not given (filled only for `r nrow(x[!is.na(x$final_outcome),])` alerts).
...
rds_file_name <- sprintf("%sclean_%s.rds",
                     undated_file_name(current_biakato),
...
cleaned_alerts_database_biakato <- x

to_export <- c("cleaned_alerts_database_biakato",
               "table_validation_overall_time",
               "table_validation_overall_past_3_weeks",
               "table_hz_total_validation",
               "table_hz_over_time_validation",
