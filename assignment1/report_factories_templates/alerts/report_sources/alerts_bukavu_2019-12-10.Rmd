---
title: "Investigation of alerts data: Bukavu"
...
This report cleans and analyses the alert data of Bukavu. Input comes from an
...
## load the data
current_bukavu
x_raw <- custom_import(current_bukavu)
glimpse(x_raw)

## extract database date from the file name
file_name <- gsub("^[^.]+/", "", current_bukavu)
...
x <- x %>% mutate(
  status = ifelse(conclusion_finale_de_l_investigation == 0, "statut_inconnu", conclusion_finale_de_l_investigation)) %>%
...
legitimate Aire de Santes belonging to Bukavu present in the database). Note - All 
...
bukavu_ha_pop <- pop_data$population
index <- which(is.na(bukavu_ha_pop))
...
Calculate number of alerts greater  than or less than 20 for recent. There is no need to restric to greater or less than 100 alerts since there are few aires de sante and with few alerts.  
...
ggplot(x, aes(x = date, fill = status)) +
  ...
  labs(x = "",
       ...
       title = paste0("Nombre d'alertes par statut de validation - Bukavu")) +
  large_txt +
  rotate_x_text(45) + 
  scale_months +
...
ggplot(x_prop, aes(x = epiweek_report_label, col = "#D56F3E")) +
  ...
  labs(x = "",
       ...
       title = paste0("Proportion d'alertes validées - Bukavu")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") +
  scale_months
...
ggplot(x_validations, aes(x = aire_de_sante, y = n, fill = status)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par statut de validation et aire de santé - Bukavu") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
There was no health area with more than 20 alerts in the past 21 days for week 45. 

```{r health_area_total_recent_greater20, fig.width = 14, eval=F}
...
ggplot(x_validations, aes(x = aire_de_sante, y = n, fill = status)) +
  ...
  labs(x = "",
       ...
       title = paste("Nombre d'alertes par statut de validation et aire de santé",
                     "\n(avec plus de 20 alertes) - Bukavu"),
        subtitle = "Données des 3 dernières semaines") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(x_validations, aes(x = aire_de_sante, y = n, fill = status)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = paste("Nombre d'alertes par statut de validation et aire de santé",
                     "\n(avec moins de 20 alertes) - Bukavu"),
        subtitle = "Données des 3 dernières semaines") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(x, aes(x = epiweek_report_label, fill = origin)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes par semaine",
       title = "Nombre d'alertes par origine - Bukavu") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45) +
  scale_months
...
ggplot(x_recent, aes(x = date, fill = origin)) +
  ...
  labs(title = "Nombre d'alertes par origine - Bukavu",
       subtitle = "Données des 3 dernières semaines ",
       x = "",
       y = "Nombre d'alertes par jour") +
  scale_weeks
...
ggplot(x, aes(x = top_zones, fill = origin)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par origine et zone de santé - Bukavu") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(x_recent, aes(x = top_zones, fill = origin)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = paste("Nombre d'alertes par origine et zone de santé - Bukavu"), 
        subtitle = "Données des 3 dernières semaines ") +
  theme(legend.position = "bottom") +
  large_txt 
...
ggplot(x_origins, aes(x = aire_de_sante, y = n, fill = origin)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par origine et aire de santé - Bukavu") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
``` {r health_area_total_recent_origin_greater20, fig.width = 14, eval=F}
...
ggplot(outcomes, aes(x = epiweek_report_label, fill = decision_comparison)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par décision de validation - Bukavu") +
  theme(legend.position = "bottom") +
  guides(fill=guide_legend(ncol=2)) +
  large_txt +
  scale_decisions +
...
ggplot(outcomes_recent, aes(x = date, fill = decision_comparison)) +
  ...
  theme(legend.position = "bottom") +
  guides(fill=guide_legend(ncol=2)) +
  labs(title = paste("Nombre d'alertes par décision de validation - Bukavu"),
       subtitle = "Données des 3 dernières semaines",
       x = "",
       y = "Nombre d'alertes par jour") +
  scale_weeks
...
```{r health_area_total_recent_decision_greater20, fig.width = 14, eval=F}
...
ggplot(x_decisions, 
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = paste("Nombre d'alertes par décision de validation", " \net aire de santé (avec plus de 20 alertes) - Bukavu"),
       subtitle = "Données des 3 dernières semaines") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(x_decisions, 
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = paste("Nombre d'alertes par décision de validation", " \net aire de santé (avec moins de 20 alertes) - Bukavu"),
       subtitle = "Données des 3 dernières semaines") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(data = x_alert_rate_sous_co, 
  ...
  labs(x = "",
       ...
       title = paste0("Nombre d'alertes par 10000 personnes", "\net par statut de validation -  Bukavu")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") +
  scale_months
...
ggplot(data = x_alert_rate_zone_sante, aes(x = zone_de_sante, 
  ...
  labs(x = "",
       ...
       title = paste0("Nombre d'alertes par 10000 personnes par statut\n", 
                      "de validation et zone de santé - Bukavu")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom")
...
ggplot(data = x_alert_rate_zone_sante, aes(x = top_zones, 
  ...
  labs(x = "",
       ...
       subtitle = "Données des 3 dernières semaines ") +
  large_txt +
  theme(legend.position = "bottom", axis.text.x = element_text(size=15)) 
...
ggplot(data = x_alert_rate_zone_sante, aes(x = aire_de_sante, 
  ...
  labs(x = "",
       y = "Nombre d'alertes par semaine \net par 10,000 personnes",
       title = paste0("Nombre d'alertes par 10000 personnes par statut ", 
                      "de validation et aire de santé - Bukavu")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") 
...
ggplot(data = x_alert_rate_aire_sante_recent, aes(x = aire_de_sante, 
  ...
  labs(x = "",
       ...
       title = paste0("Nombre d'alertes par 10000 personnes, par statut de validation", " \net par aire de santé - Bukavu"), 
        subtitle = "Données des 3 dernières semaines ") + 
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") 
...
*NOTE*: As of the latest database from Bukavu on Dec, 12th 2019, the **final outcome of the alerts**, in the variable `classification_finale_du_cas` was not given (filled only for `r nrow(x[!is.na(x$final_outcome),])` alerts.
...
rds_file_name <- sprintf("%sclean_%s.rds",
                     undated_file_name(current_bukavu),
...
cleaned_alerts_database_bukavu <- x

to_export <- c("cleaned_alerts_database_bukavu",
               "table_validation_overall_time",
               "table_validation_overall_past_3_weeks",
               "table_hz_total_validation",
               "table_hz_over_time_validation",
