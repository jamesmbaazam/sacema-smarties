...
#cases by sex
case_status_by_sex <- ebola_dat_outbreak2 %>% 
    group_by(status, sex) %>% 
    count()
...
- `r n_deaths_outbreak2` number of deaths have been reported so far. 
 - As of `r last_reporting_date`, a total of `r nrow(ebola_dat)` EVD cases, including `r total_confirmed` confirmed and `r total_probable` probable cases have been reported in Uganda. Out of the total confirmed and probable cases, there have been `r total_deaths` deaths. Of the total confirmed and probable cases, <state number of cases which are male and female>.
